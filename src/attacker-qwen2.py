...
parser.add_argument("--model_nickname", type=str, default="qwen2_7B")
parser.add_argument("--classifier_type", type=str, default="safety")
parser.add_argument("--output_path", type=str, default="./saved_models/qwen2_7B-scav_and_mask-refat/classifier-attacker")
