...
parser.add_argument("--model_nickname", type=str, default="llama3_8B")
parser.add_argument("--classifier_type", type=str, default="safety")
parser.add_argument("--output_path", type=str, default="./saved_models/mask-refat/classifier-attacker")
...
# clfr = torch.load("./saved_models/classifier-attacker/safety_llama3_8B.pth")
...
#
# max_nums = 50
# with open("./data/over-refusal_test/or-bench_un-overleap_test.json") as f:
#     train_data = json.load(f)
