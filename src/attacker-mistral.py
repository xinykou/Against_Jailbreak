...
parser.add_argument("--model_nickname", type=str, default="mistral_7B")
parser.add_argument("--classifier_type", type=str, default="safety")
parser.add_argument("--output_path", type=str, default="./saved_models/mistral_7B-scav_and_mask-refat/classifier-attacker")
